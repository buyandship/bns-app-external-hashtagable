...
class HashTagTextField extends StatefulWidget {
  ...
  const HashTagTextField({
    ...
    this.allowEmoji = false,
        ...
        assert(maxLength == null || maxLength == HashTagTextField.noMaxLength || maxLength > 0),
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<TextStyle>('style', basicStyle, defaultValue: null));
...
class _HashTagTextFieldState extends State<HashTagTextField> with RestorationMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  Widget build(BuildContext context) {
    ...
    assert(
      !(widget.basicStyle != null && widget.basicStyle!.inherit == false && (widget.basicStyle!.fontSize == null || widget.basicStyle!.textBaseline == null)),
    ...
    Widget child = RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: HashTagEditableText(
          key: editableTextKey,
          decoratedStyle: widget.decoratedStyle ?? style.copyWith(color: Colors.blue),
